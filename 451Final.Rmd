...
2. Then what effect could U have? Within each U –> Y assumptioin, the various effect magnitude U –> A seems to result in more obvious negative effect when receiving large donation versus smaller donation. 
